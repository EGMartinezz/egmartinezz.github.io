...
// aaaa 
    ...
    function decideSpeed(){
        return Math.random() * doubleMaxSpeed/2 - doubleMaxSpeed/2;
    }
    ...
    function bounceCircle(circle){
        ...
        else if (circle.x + circleRadius > boardWidth){
            circle.x = boardWidth - circleRadius;
            circle.speedX *= -1;
        }
        ...
        else if (circle.y + circleRadius > boardHeight){
            circle.y = boardHeight - circleRadius;
            circle.speedY *= -1;
        }
    }
    ...
    function updateCircleOnScreen(circle){
        ...
        $(circle.id).css('left', circle.x - circleRadius);
        $(circle.id).css('top', circle.y - circleRadius);
    }
});